...
export const PrintReportFooter: React.FC<PrintReportFooterProps> = ({
  ...
  return (
    <div className="hidden print:block print-document-footer mt-3 pt-2 border-t border-slate-300 text-slate-800 break-inside-avoid page-break-inside-avoid">
      {/* Formal Signature Blocks */}
      <div className="grid grid-cols-3 gap-4 text-center pt-1 pb-2 text-[9.5px]">
        <div>
          <p className="font-bold uppercase tracking-wider text-slate-900">NGƯỜI LẬP BÁO CÁO</p>
          <p className="text-[8.5px] text-slate-500 italic mt-0.5">(Ký, ghi rõ họ tên)</p>
          <div className="h-9" />
        ...
        <div>
          ...
          <p className="text-[8.5px] text-slate-500 italic mt-0.5">(Ký, duyệt nội dung)</p>
          <div className="h-9" />
        ...
        <div>
          ...
          <p className="text-[8.5px] text-slate-500 italic mt-0.5">(Phê duyệt & Chỉ đạo)</p>
          <div className="h-9" />
      ...
      {/* Footer Bottom Note */}
      <div className="pt-1 border-t border-slate-200 flex items-center justify-between text-[8px] text-slate-500">
        <p>
